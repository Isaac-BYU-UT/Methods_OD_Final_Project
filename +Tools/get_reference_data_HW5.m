function ref_data = get_reference_data_HW5()
    ...
    if isempty(ref_data_cached)
        ...
        ref_data_cached = struct('A_t0_ref', A_t0_ref, 'H_tilde_t0_ref', H_tilde_t0_ref, 'STM_21600_0_ref', STM_21600_0_ref, 'Light_Time_Truth_ref', Light_Time_Truth_ref, 'Actual_Measurements', table2struct(Actual_Measurements,'ToScalar',true));
