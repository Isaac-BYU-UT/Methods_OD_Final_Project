function IC = initial_conditions_HW5_EXCLUDE_RANGE_RATE()
...
Range_Rate_STD_Atoll_km_s = 1.0 * Constants.METERS_TO_KM / 1000 * Almost_Infinite; % mm/s to km/s
...
Range_Rate_STD_Arecibo_km_s = 1.0 * Constants.METERS_TO_KM / 1000 * Almost_Infinite; % mm/s to km/s
