function IC = initial_conditions_Phase1_EXCLUDE_RANGE()

IC.name = 'Final Phase 1 Exclude Range';
IC.description = 'Final Phase 1 Exclude Range';    
...
Range_STD_Atoll_km = 10 * Constants.METERS_TO_KM * Almost_Infinite;
Range_Rate_STD_Atoll_km_s = 0.5 * Constants.METERS_TO_KM / 1000; % mm/s to km/s

Range_STD_Diego_Garcia_km = 5 * Constants.METERS_TO_KM * Almost_Infinite;
Range_Rate_STD_Diego_Garcia_km_s = 1.0 * Constants.METERS_TO_KM / 1000; % mm/s to km/s

Range_STD_Arecibo_km = 10 * Constants.METERS_TO_KM * Almost_Infinite;
Range_Rate_STD_Arecibo_km_s = 0.5 * Constants.METERS_TO_KM / 1000; % mm/s to km/s
