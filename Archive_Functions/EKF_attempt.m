...
% x_bar_correction_0 = zeros(N_states,1); % Omitted in EKF
...
% x_hat_correction_i_minus_1 = x_bar_correction_0; % Omitted in EKF
...
if t_obs(1) == 0  % Or whatever your epoch time is
    ...
    x_hat_correction_i_minus_1 = K_0 * y_residuals_0; 
    ...
    X_updated = X_star_input_ti_minus_1(1:N_states); 
    ...
    fprintf('t=0 (i=1) EKF Update Complete.\n');
