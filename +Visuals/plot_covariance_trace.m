function plot_covariance_trace(ekf)
    ...
    semilogy(t_obs_hours(valid_idx), ekf.trace_post_propagation(valid_idx), 'b-o', ...
        'LineWidth', 2, 'MarkerSize', 4, 'DisplayName', 'After Propagation (P_bar)');
    semilogy(t_obs_hours(valid_idx), ekf.trace_post_update(valid_idx), 'r-s', ...
        'LineWidth', 2, 'MarkerSize', 4, 'DisplayName', 'After Update (P)');
    semilogy(t_obs_hours(valid_idx), ekf.trace_pre_propagation(valid_idx), 'k-^', ...
