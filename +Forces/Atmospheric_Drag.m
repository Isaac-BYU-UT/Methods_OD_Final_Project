function accel_drag_km_s2 = Atmospheric_Drag(r_km, v_km_s, C_drag)
    % r_km: position vector in ECI frame (km)
    % v_km_s: velocity vector in ECI frame (km/s)
