function accel_drag_meters_s2 = Atmospheric_Drag(r_ECI_meters, v_ECI_meters_s, C_drag, r_sun_rel_earth_ECI_meters)
    ...
    % Account for earth's rotational velocity, DON"T FLIP YOUR SIGN YOU
    % HOLIGAN!
    ...
    Area_m2 = SatelliteProperties.AREA_X_FACE_M2 * abs(dot(v_rel_hat_unit,x_hat_unit_vec_ECI)) + ...
                SatelliteProperties.AREA_Y_FACE_M2 * abs(dot(v_rel_hat_unit,y_hat_unit_vec_ECI)) + ...
