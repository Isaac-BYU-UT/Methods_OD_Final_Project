...
Acceleration_Computation_func = matlabFunction(a_total, 'Vars', {r_km, v_km_s, C_drag, r_sun_rel_earth_ECI_km, r_moon_rel_earth_ECI_km});
A_matrix_computation_func = matlabFunction(A_matrix, 'Vars', {r_km, v_km_s, C_drag, r_sun_rel_earth_ECI_km, r_moon_rel_earth_ECI_km});
