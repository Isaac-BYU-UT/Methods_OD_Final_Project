function accel_solar_radiation_pressure_meters_s2 = Solar_Radiation_Pressure_SP_Only(r_sat_rel_earth_ECI_meters, r_sun_rel_earth_ECI_meters, sat_is_illuminated) 
    ...
    a_srp_meters_s2 = - (PhysicsConstants.SOLAR_PRESSURE_N_M2 / d_AU^2) * ...
                      ...
                      ( B_theta * n_hat + (1 - mu) * cosd(phi_inclination_deg) * u_hat );
