function IC = initial_conditions_Phase1()

IC.name = 'Final Phase 1 All Data';
IC.description = 'Final Phase 1';    
...
IC.Sigma_Accel_km_s2 = 10e-11; % TODO: TUNE THIS GUESS! % If we go larger than 10e-8, we get problems!
