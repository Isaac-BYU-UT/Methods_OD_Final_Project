function IC = initial_conditions_HW5_EXCLUDE_RANGE()
...
Range_STD_Atoll_km = 5 * Constants.METERS_TO_KM * Almost_Infinite;
...
Range_STD_Arecibo_km = 5 * Constants.METERS_TO_KM * Almost_Infinite;
