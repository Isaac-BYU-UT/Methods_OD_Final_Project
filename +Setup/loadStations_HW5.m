function Stations = loadStations_HW5()
    ...
    Stations(1).sigma_range_meters = 5; % Standard deviation of range measurement in meters
    Stations(1).sigma_range_rate_meters_per_sec = 1.0 * Units.MILIMETERS; % Standard deviation of range rate measurement in meters per second
    ...
    Stations(3).sigma_range_meters = 5; % Standard deviation of range measurement in meters
    Stations(3).sigma_range_rate_meters_per_sec = 1.0 * Units.MILIMETERS; % Standard deviation of range rate measurement in meters per second
